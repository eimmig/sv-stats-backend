...
public class DimensionResolver {
	...
	// sportId faz parte da chave - o mesmo nome de time pode existir em esportes diferentes. Nem
	// toda aposta referencia os 2 lados (ex. mercado sem confronto de dois lados) - null passa
	// direto.
